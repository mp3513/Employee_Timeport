...
?>
<form name="TimeSheetDetail" id="TimeSheetDetail" method="post" class="entertimepopup"  action="updateTimeSheet.php" style="height:650px;width:719px;" >
<h1 style=" margin: 0;
  padding: 0 0 8px 0;
  font-size: 12px;"><?php			
...
<textarea name="timeSheetcomments" onkeyup="countChar(this)" maxlength="298" id="timeSheetcomments" style="width: 545px; height: 60px;margin-left:26px;"><?php echo $data[TimesheetComments];?></textarea>
...
<textarea readonly="readonly" name="timeSheetcomments"  maxlength="298" id="timeSheetcomments" style="width: 545px; height: 60px;margin-left:26px;"><?php echo $data[TimeSheetClientComments]; ?></textarea>
...
<div class="button-bar"><input type="submit" value="Save As Viewed" name="submit_upload_button"  class="btn_style"> &nbsp;

<input type="submit" value="Mark as Ignored" name="submit_upload_button"  class="btn_style"> &nbsp;
