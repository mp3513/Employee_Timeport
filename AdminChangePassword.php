...
$("#submit_button").click(function() {
 ...
 if(oldPassword=='' || newPassword=='' ){
	...
	data: dataString,
		...
		data =$.trim(data);		
		if(data == "SUCCESS") {			
		$("#ErrorMsg").html("<span class='success_msg'><b>Success :</b>Password change successfully</span>");								
		$("#oldPassword").val("");
		$("#newPassword").val("");
		$("#confirmPassword").val("");
	...
	<div class="main">
	    ...
	    ?>
			...
			<div class="right">				
				<ul>
					<li>
						<a href="ViewTimeExpenseHistory.php?func=search" class="back_btn"><span></span>Back</a>
					</li>
					<li>
...
<div class="main" id="container_style">
	<div class="text_container">
		...
		<form method="post" action="admin_change_password.php">
				...
				<tr>
				<td colspan='2' align='center' style="padding:0px 0 10PX 0;">
				<img src="images\logged-as.png" />&nbsp;&nbsp;&nbsp; Logged in as <?php echo "<b>".$_SESSION['UserSessionObject']['UserID']."</b>";?>
				</td>
				</tr>
